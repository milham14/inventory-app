...
export class CustomerComponent implements OnInit, AfterViewInit {
  ...
  simpanUser() {
    if (this.selectedUser) {
      // Edit existing user
      this.selectedUser.nama_customer = this.newUser.nama_customer;
      this.selectedUser.alamat_customer = this.newUser.alamat_customer;
    } else {
      // Add new user
      this.dataSource.push({
        nama_customer: this.newUser.nama_customer,
        alamat_customer: this.newUser.alamat_customer,
      });
    }
